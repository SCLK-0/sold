...
this.player.y += this.player.vy;
      ...
      if (this.player.isShooting && typeof this.player.shootAngle === "number") {
    if (!this.player.shootCooldown || this.player.shootCooldown <= 0) {
        this.shootProjectile(this.player.x, this.player.y, this.player.shootAngle);
        this.player.shootCooldown = 10; // adjust to control fire rate
    } else {
